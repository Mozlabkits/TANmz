...
===========================================================
 QUÍMICA — 10ª CLASSE
 ALINHADO AO PROGRAMA OFICIAL DO ENSINO SECUNDÁRIO
===========================================================
*/
...
'Química, matéria e método científico',
'Química e matéria',
'Química é a ciência que estuda a matéria, a sua composição, estrutura, propriedades, transformações e as relações energéticas envolvidas nessas transformações.',
[
'A Química está relacionada com áreas como Biologia, Física, Medicina, Agricultura e Engenharia.',
'O método científico permite investigar fenómenos de forma organizada e baseada em evidências.',
'A matéria pode ser classificada em substâncias e misturas.',
'As propriedades da matéria podem ser gerais, específicas e funcionais.'
],
'Investigação da água',
'Um estudante pode observar a qualidade de uma amostra de água, formular uma hipótese, realizar testes, analisar os resultados e chegar a uma conclusão.',
'Ciência e comunidade',
'A Química ajuda a compreender água, alimentos, medicamentos, fertilizantes, combustíveis e materiais utilizados diariamente.',
'ciência',
'Pensar que Química existe apenas dentro de um laboratório.',
'A Química está presente nos fenómenos e materiais do quotidiano e utiliza o laboratório para investigar e comprovar explicações.',
[
'Química estuda a matéria e suas transformações.',
'O método científico organiza a investigação.',
'A matéria pode ser substância ou mistura.',
'Propriedades ajudam a identificar e caracterizar materiais.'
],
'Qual é um dos objetos de estudo da Química?',
['A matéria e suas transformações','Somente os seres vivos','Somente os planetas','Somente os números'],
0,
'A Química estuda a composição, estrutura, propriedades e transformações da matéria.',
'Qual etapa normalmente vem depois da formulação de uma hipótese?',
['Experimentação','Conclusão imediata','Ignorar os resultados','Publicação antes do teste'],
0,
'A experimentação permite testar a hipótese formulada.'
),
...
'chem-10-u1',
'Fundamentos de Química',
'Classificação da matéria e misturas',
'Matéria',
'Matéria é tudo aquilo que possui massa e ocupa lugar no espaço. Pode apresentar diferentes estados físicos e diferentes composições.',
[
'Substâncias puras apresentam composição definida e podem ser simples ou compostas.',
'Misturas resultam da combinação de duas ou mais substâncias.',
'Misturas homogéneas apresentam uma única fase visível, enquanto misturas heterogéneas apresentam duas ou mais fases.',
'Métodos como filtração, decantação, destilação e cromatografia permitem separar componentes de misturas.'
],
'Água salgada',
'A água salgada é uma mistura homogénea porque o sal está distribuído uniformemente na água.',
'Tratamento e produção',
'A separação de misturas é utilizada no tratamento de água, produção de sal, recuperação de materiais e processos industriais.',
'separação',
'Pensar que toda mistura homogénea é uma substância pura.',
'Uma mistura homogénea possui composição uniforme, mas continua sendo constituída por mais de uma substância.',
[
'Substância pura possui composição definida.',
'Mistura contém duas ou mais substâncias.',
'Mistura homogénea apresenta uma fase.',
'Métodos de separação exploram propriedades físicas diferentes.'
],
'Qual é uma mistura homogénea?',
['Água com sal dissolvido','Água e areia','Óleo e água','Pedras e areia'],
0,
'O sal dissolvido distribui-se uniformemente na água.',
'Qual método pode separar areia da água?',
['Filtração','Destilação fracionada','Cromatografia gasosa','Liquefação'],
0,
'A filtração retém a areia enquanto a água atravessa o filtro.'
),
...
'Equação química',
'Equação química é uma representação simbólica de uma reação química, mostrando os reagentes, os produtos e as proporções relativas entre as partículas envolvidas.',
[
'Os reagentes são as substâncias que participam inicialmente da reação.',
'Os produtos são as substâncias formadas.',
'Os coeficientes indicam proporções entre as espécies químicas.',
'Uma equação deve respeitar a conservação dos átomos de cada elemento.'
],
'Formação da água',
'Na formação da água, hidrogénio e oxigénio reagem segundo uma proporção representada por uma equação química balanceada.',
'Laboratório',
'A linguagem química permite comunicar reações de forma universal e realizar cálculos quantitativos.',
'linguagem_quimica',
'Alterar os índices das fórmulas para balancear uma equação.',
'Para balancear uma equação química devem ser alterados os coeficientes, preservando as fórmulas das substâncias.',
[
'Equações representam reações.',
'Reagentes aparecem no lado inicial.',
'Produtos são formados pela reação.',
'Coeficientes são usados para balancear equações.'
],
'Por que uma equação química deve ser balanceada?',
['Para respeitar a conservação dos átomos','Para mudar os elementos','Para criar novos átomos','Para eliminar a massa'],
0,
'O número de átomos de cada elemento deve ser conservado durante a reação.',
'Na equação 2H₂ + O₂ → 2H₂O, o número de moléculas de água indicado é:',
['2','1','3','4'],
0,
'O coeficiente 2 indica duas unidades de H₂O.'
),
...
'Estequiometria',
'Estequiometria é o ramo da Química que permite calcular quantitativamente as relações entre reagentes e produtos numa reação química.',
[
'A estequiometria baseia-se na equação química balanceada.',
'O mol relaciona quantidade de matéria com número de partículas.',
'A massa molar permite relacionar massa e quantidade de matéria.',
'As leis de Lavoisier, Proust e Avogadro são importantes para os cálculos químicos.'
],
'Combustão do metano',
'Na combustão do metano, a equação balanceada permite determinar as quantidades relativas de metano e oxigénio necessárias.',
'Indústria',
'Cálculos estequiométricos são usados para controlar reagentes, custos, rendimento e produção industrial.',
'cálculos',
'Fazer cálculos usando uma equação química não balanceada.',
'A equação deve ser balanceada antes dos cálculos estequiométricos.',
[
'Estequiometria envolve relações quantitativas.',
'A equação deve estar balanceada.',
'Mol é fundamental nos cálculos.',
'Massa molar relaciona massa e mol.'
],
'Qual grandeza representa a quantidade de matéria?',
['Mol','Litro','Metro','Pascal'],
0,
'O mol é a unidade do SI para quantidade de matéria.',
'Se 1 mol de uma substância possui massa molar de 20 g/mol, qual é a massa de 2 mol?',
['40 g','20 g','10 g','2 g'],
0,
'm = n × M = 2 × 20 = 40 g.'
),
...
'Química',
'chem-10-u2',
'Enxofre e elementos do grupo VIA',
'Enxofre e seus compostos',
'Enxofre',
'O enxofre é um elemento químico do grupo VIA ou grupo 16 da Tabela Periódica, apresentando diferentes formas alotrópicas e formando diversos compostos.',
[
'O enxofre pode ser encontrado na natureza em depósitos minerais e associado a outros elementos.',
'Apresenta variedades alotrópicas, incluindo as formas rômbica e monoclínica.',
'O enxofre forma compostos como dióxido de enxofre, trióxido de enxofre e ácido sulfúrico.',
'O enxofre e seus compostos possuem importância industrial e agrícola.'
],
'Ácido sulfúrico',
'O ácido sulfúrico é um dos produtos químicos industriais mais importantes e participa de diversos processos de produção.',
'Indústria e agricultura',
'Compostos de enxofre são utilizados na produção de fertilizantes, produtos químicos e outros materiais.',
'indústria',
'Pensar que o enxofre possui apenas aplicações benéficas.',
'Alguns compostos de enxofre podem ser perigosos e contribuir para problemas ambientais, dependendo da quantidade e das condições de emissão.',
[
'Enxofre pertence ao grupo VIA.',
'Apresenta alotropia.',
'Forma vários compostos importantes.',
'Alguns óxidos de enxofre afetam a qualidade do ar.'
],
'Em que grupo da Tabela Periódica está o enxofre?',
['Grupo VIA ou 16','Grupo IA','Grupo VIIIA','Grupo II'],
0,
'O enxofre pertence ao grupo 16, tradicionalmente chamado VIA.',
'Qual composto de enxofre é importante industrialmente?',
['H₂SO₄','NaCl','CaCO₃','CH₄'],
0,
'O ácido sulfúrico possui grande importância industrial.'
),
...
'Química',
'chem-10-u3',
'Nitrogénio e elementos do grupo VA',
'Nitrogénio, fósforo e fertilizantes',
'Nitrogénio',
'O nitrogénio é um elemento do grupo VA ou grupo 15, essencial para a vida e importante na produção de compostos utilizados na agricultura e na indústria.',
[
'O nitrogénio molecular constitui grande parte do ar atmosférico.',
'O nitrogénio participa da composição de proteínas e ácidos nucleicos nos seres vivos.',
'O amoníaco é uma importante substância nitrogenada industrial.',
'O fósforo e seus compostos também possuem grande importância agrícola, especialmente na produção de fertilizantes.'
],
'Fertilizantes nitrogenados',
'Compostos de nitrogénio podem fornecer nutrientes necessários ao crescimento das plantas.',
'Agricultura',
'O conhecimento da Química permite compreender a composição e utilização racional dos fertilizantes.',
'agricultura',
'Pensar que mais fertilizante significa sempre maior produção.',
'O excesso de fertilizantes pode causar desequilíbrios no solo e poluição da água.',
[
'Nitrogénio pertence ao grupo 15.',
'É importante para os seres vivos.',
'Participa na produção de fertilizantes.',
'Fertilizantes devem ser utilizados racionalmente.'
],
'Qual elemento é essencial na composição das proteínas?',
['Nitrogénio','Hélio','Neon','Argónio'],
0,
'O nitrogénio integra aminoácidos e, consequentemente, proteínas.',
'Qual é uma consequência possível do uso excessivo de fertilizantes?',
['Poluição de águas e desequilíbrio ambiental','Produção ilimitada sem efeitos','Purificação automática do solo','Eliminação de todos os microrganismos'],
0,
'O excesso de nutrientes pode alcançar corpos de água e provocar impactos ambientais.'
),
...
'Funções orgânicas oxigenadas',
'Funções orgânicas oxigenadas são famílias de compostos orgânicos que possuem oxigénio em grupos funcionais característicos, como álcoois, fenóis e éteres.',
[
'Álcoois possuem grupo hidroxilo ligado a carbono saturado.',
'Fenóis possuem grupo hidroxilo ligado diretamente a um anel aromático.',
'Éteres apresentam um átomo de oxigénio entre dois grupos orgânicos.',
'A estrutura do grupo funcional influencia as propriedades e reatividade dos compostos.'
],
'Etanol',
'O etanol é um álcool utilizado como solvente, combustível e componente de alguns produtos, apresentando propriedades diferentes das de outros compostos orgânicos.',
'Indústria',
'Álcoois e éteres possuem aplicações em solventes, combustíveis, produtos farmacêuticos e outros processos industriais.',
'orgânica',
'Considerar todos os compostos que possuem OH como álcoois.',
'Fenóis também possuem OH, mas o grupo hidroxilo está ligado diretamente a um anel aromático.',
[
'Álcoois possuem grupo hidroxilo.',
'Fenóis possuem OH ligado a anel aromático.',
'Éteres possuem oxigénio entre grupos orgânicos.',
'A estrutura determina propriedades.'
],
'Qual grupo funcional caracteriza um álcool?',
['-OH','-COOH','-NH₂','-NO₂'],
0,
'O grupo hidroxilo é característico dos álcoois.',
'Qual composto representa um éter?',
['CH₃-O-CH₃','CH₃COOH','CH₃OH','CH₄'],
0,
'No éter existe um átomo de oxigénio ligado a dois grupos orgânicos.'
),
...
'Compostos carbonílicos e derivados',
'Aldeídos, cetonas, ácidos carboxílicos e ésteres são importantes funções orgânicas oxigenadas com diferentes grupos funcionais e propriedades.',
[
'Aldeídos possuem o grupo carbonilo na extremidade da cadeia.',
'Cetonas possuem o grupo carbonilo ligado a dois carbonos.',
'Ácidos carboxílicos possuem o grupo carboxilo.',
'Ésteres apresentam o grupo funcional característico -COO- e estão relacionados com aromas, fragrâncias e outros produtos.'
],
'Vinagre e aromas',
'O ácido acético presente no vinagre é um ácido carboxílico, enquanto muitos ésteres apresentam odores característicos usados em fragrâncias e aromatizantes.',
'Alimentos e indústria',
'Essas funções aparecem em alimentos, perfumes, medicamentos, solventes e diversos processos industriais.',
'orgânica',
'Confundir aldeído com cetona.',
'A posição do grupo carbonilo diferencia aldeídos e cetonas.',
[
'Aldeídos possuem carbonilo terminal.',
'Cetonas possuem carbonilo entre carbonos.',
'Ácidos carboxílicos possuem -COOH.',
'Ésteres possuem -COO-.'
],
'Qual grupo funcional caracteriza um ácido carboxílico?',
['-COOH','-OH apenas','-COO-','-NH₂'],
0,
'O grupo carboxilo -COOH caracteriza os ácidos carboxílicos.',
'Qual substância está presente no vinagre como principal ácido?',
['Ácido acético','Metano','Etano','Benzeno'],
0,
'O ácido acético, ou ácido etanoico, é o principal ácido do vinagre.'
)
...
'chem-11-u1',
'Estrutura Atómica',
'Modelos atómicos e partículas fundamentais',
'Estrutura do átomo',
'Átomo é uma unidade fundamental da matéria constituída por núcleo, contendo protões e neutrões, e uma região eletrónica onde se encontram os eletrões.',
[
'Protões possuem carga elétrica positiva.',
'Eletrões possuem carga elétrica negativa.',
'Neutrões não possuem carga elétrica líquida.',
'O modelo atómico evoluiu à medida que novas evidências experimentais foram obtidas.'
],
'Experiência de Rutherford',
'A experiência de Rutherford mostrou a existência de um núcleo pequeno, denso e positivo no átomo.',
'Ciência',
'O estudo da estrutura atómica explica propriedades químicas e a organização dos elementos.',
'átomo',
'Pensar que o modelo de Rutherford é a descrição final do átomo.',
'Os modelos atómicos são modelos científicos que foram aperfeiçoados com novas evidências.',
[
'Protões são positivos.',
'Eletrões são negativos.',
'Neutrões são eletricamente neutros.',
'O núcleo contém protões e neutrões.'
],
'Qual partícula possui carga negativa?',
['Eletrão','Protão','Neutrão','Núcleo'],
0,
'O eletrão possui carga elétrica negativa.',
'Qual experiência contribuiu para a descoberta do núcleo atómico?',
['Experiência de Rutherford','Experiência de combustão','Destilação','Cromatografia'],
0,
'O espalhamento de partículas alfa levou Rutherford a propor um núcleo pequeno e denso.'
),
...
'chem-11-u1',
'Estrutura Atómica',
'Modelo de Bohr e mecânica quântica',
'Modelo atómico de Bohr',
'O modelo de Bohr propõe que os eletrões podem ocupar estados de energia definidos e que transições entre esses estados estão associadas à emissão ou absorção de energia.',
[
'Os eletrões não podem possuir qualquer valor arbitrário de energia no modelo de Bohr.',
'A absorção de energia pode promover um eletrão para um estado de maior energia.',
'A emissão de energia pode ocorrer quando o eletrão passa para um estado de menor energia.',
'A mecânica quântica moderna descreve os eletrões através de estados quânticos e orbitais.'
],
'Espectros atómicos',
'As linhas espectrais dos elementos estão relacionadas com diferenças quantizadas de energia.',
'Tecnologia',
'O conhecimento da estrutura eletrónica é utilizado em espectroscopia, iluminação, lasers e identificação de elementos.',
'energia',
'Pensar que os eletrões percorrem sempre órbitas circulares como planetas.',
'O modelo quântico descreve probabilidades de encontrar eletrões em orbitais.',
[
'Eletrões possuem níveis de energia.',
'Transições envolvem energia.',
'Bohr introduziu níveis quantizados.',
'A mecânica quântica utiliza orbitais.'
],
'Quando um eletrão passa para um nível de maior energia, ele:',
['Absorve energia','Liberta necessariamente toda a energia','Desaparece','Transforma-se em protão'],
0,
'A passagem para um estado de maior energia requer absorção de energia.',
'Na descrição quântica, orbital representa:',
['Uma região de elevada probabilidade de encontrar um eletrão','Uma órbita planetária exata','O núcleo do átomo','Uma partícula positiva'],
0,
'Um orbital é uma região do espaço associada à probabilidade de encontrar um eletrão.'
),
...
'Tabela Periódica',
'A Tabela Periódica organiza os elementos químicos segundo o número atómico e evidencia padrões periódicos nas suas propriedades.',
[
'O número atómico corresponde ao número de protões do átomo.',
'As linhas horizontais são períodos.',
'As colunas são grupos ou famílias.',
'Elementos do mesmo grupo possuem configurações de valência relacionadas e apresentam propriedades químicas semelhantes.'
],
'Grupo dos halogénios',
'Os elementos do grupo 17 possuem propriedades semelhantes e tendem a formar compostos com vários metais.',
'Química e indústria',
'A Tabela Periódica permite prever propriedades e orientar a escolha de elementos em aplicações químicas.',
'tabela_periodica',
'Pensar que os elementos estão organizados apenas por massa.',
'A Tabela Periódica moderna é organizada pelo número atómico crescente.',
[
'Número atómico é o número de protões.',
'Períodos são linhas.',
'Grupos são colunas.',
'Propriedades apresentam periodicidade.'
],
'O que determina a identidade de um elemento?',
['Número de protões','Número de neutrões apenas','Número de moléculas','Massa da amostra'],
0,
'O número de protões define o número atómico e a identidade do elemento.',
'Elementos do mesmo grupo tendem a apresentar:',
['Propriedades químicas semelhantes','Sempre a mesma massa','Sempre o mesmo número de neutrões','O mesmo símbolo'],
0,
'A configuração eletrónica de valência contribui para semelhanças químicas dentro de um grupo.'
),
...
'Propriedades periódicas',
'Propriedades periódicas são características dos elementos que apresentam variações regulares ao longo dos períodos e grupos da Tabela Periódica.',
[
'O raio atómico tende a diminuir da esquerda para a direita em um período.',
'O raio atómico tende a aumentar de cima para baixo em um grupo.',
'A energia de ionização geralmente aumenta da esquerda para a direita.',
'A eletronegatividade geralmente aumenta da esquerda para a direita e de baixo para cima.'
],
'Comparação entre elementos',
'A posição de um elemento na Tabela permite fazer previsões sobre seu comportamento químico.',
'Previsão química',
'As tendências periódicas ajudam a prever reatividade, formação de iões e tipos de ligações.',
'propriedades',
'Memorizar tendências sem compreender a influência da carga nuclear e dos níveis eletrónicos.',
'As tendências estão relacionadas com a atração do núcleo pelos eletrões e com o número de camadas eletrónicas.',
[
'Raio atómico varia periodicamente.',
'Energia de ionização apresenta tendência periódica.',
'Eletronegatividade ajuda a prever polaridade das ligações.',
'A posição na Tabela permite fazer previsões.'
],
'Em geral, o raio atómico aumenta:',
['De cima para baixo num grupo','Da direita para esquerda apenas','Sempre para a direita','Somente no centro'],
0,
'Novas camadas eletrónicas são adicionadas ao descer um grupo.',
'Qual propriedade mede a tendência de um átomo atrair eletrões numa ligação?',
['Eletronegatividade','Massa molar','Densidade','Ponto de fusão'],
0,
'A eletronegatividade descreve a atração relativa pelos eletrões de ligação.'
),
...
'chem-11-u3',
'Ligação Química',
'Tipos de ligação e estrutura de Lewis',
'Ligação química',
'Ligação química é a interação que mantém átomos ou iões associados numa estrutura estável, envolvendo principalmente os eletrões de valência.',
[
'A ligação iónica envolve atração entre iões de cargas opostas.',
'A ligação covalente envolve compartilhamento de eletrões entre átomos.',
'A ligação metálica envolve uma rede de átomos metálicos com eletrões deslocalizados.',
'As estruturas de Lewis representam eletrões de valência e ajudam a visualizar ligações.'
],
'Cloreto de sódio',
'No NaCl, o sódio perde um eletrão e o cloro recebe esse eletrão, formando iões com cargas opostas.',
'Materiais',
'Compreender ligações ajuda a explicar propriedades como solubilidade, condutividade e pontos de fusão.',
'ligações',
'Pensar que ligação iónica é simplesmente uma molécula individual.',
'Compostos iónicos formam estruturas cristalinas constituídas por uma rede de iões.',
[
'Ligação iónica envolve iões.',
'Covalente envolve compartilhamento.',
'Metálica envolve eletrões deslocalizados.',
'Lewis representa eletrões de valência.'
],
'Que tipo de ligação predomina no NaCl?',
['Iónica','Covalente apolar','Metálica','Nuclear'],
0,
'NaCl é constituído por iões Na+ e Cl− organizados numa rede cristalina.',
'Qual ligação envolve compartilhamento de eletrões?',
['Covalente','Iónica exclusivamente','Metálica exclusivamente','Nuclear'],
0,
'A ligação covalente forma-se pelo compartilhamento de pares de eletrões.'
),
...
'Ligas metálicas',
'Ligas metálicas',
'Ligas metálicas são materiais formados pela combinação de dois ou mais elementos, sendo pelo menos um deles metal, para obter propriedades específicas.',
[
'A composição de uma liga influencia suas propriedades.',
'Ligas podem apresentar maior resistência mecânica ou resistência à corrosão.',
'O aço é uma liga baseada principalmente em ferro e carbono.',
'O bronze é uma liga tradicionalmente associada a cobre e estanho.'
],
'Aço',
'O aço apresenta propriedades diferentes das do ferro puro e é utilizado em estruturas e ferramentas.',
'Construção',
'Ligas metálicas são fundamentais na construção civil, transporte, ferramentas e indústria.',
'materiais',
'Pensar que uma liga é necessariamente uma substância elementar.',
'Ligas são materiais com composição formada por mais de um elemento.',
[
'Ligas combinam elementos.',
'Propriedades dependem da composição.',
'Aço contém principalmente ferro e carbono.',
'Ligas têm ampla aplicação tecnológica.'
],
'O aço é principalmente uma liga de:',
['Ferro e carbono','Sódio e cloro','Hidrogénio e oxigénio','Cálcio e água'],
0,
'O aço é uma liga baseada principalmente em ferro e carbono.',
'Por que são produzidas ligas metálicas?',
['Para obter propriedades desejadas','Para eliminar todos os átomos','Para transformar metais em gases','Para impedir qualquer ligação'],
0,
'A composição das ligas pode ser ajustada para obter propriedades úteis.'
),
...
'Compostos inorgânicos são substâncias classificadas em famílias químicas com propriedades características, incluindo óxidos, ácidos, bases e sais.',
[
'Óxidos são compostos binários nos quais o oxigénio está ligado a outro elemento, com exceções específicas.',
'Ácidos apresentam comportamento característico em solução aquosa e podem fornecer H+ em modelos apropriados.',
'Bases podem produzir OH− em água ou atuar como aceitadoras de protões, dependendo do modelo.',
'Sais são compostos iónicos formados por catiões e aniões, frequentemente resultantes de reações ácido-base.'
],
'Neutralização',
'Uma reação entre um ácido e uma base pode produzir sal e água, sendo chamada neutralização em muitos casos.',
'Laboratório e agricultura',
'As classes inorgânicas são importantes em medicamentos, fertilizantes, limpeza, tratamento de água e indústria.',
'inorgânica',
'Pensar que todo composto contendo oxigénio é um óxido.',
'Óxidos são classificados como compostos binários específicos e devem ser analisados pela sua composição.',
[
'Óxidos são compostos binários com oxigénio.',
'Ácidos e bases apresentam propriedades características.',
'Sais são frequentemente compostos iónicos.',
'Neutralização pode produzir sal e água.'
],
'Qual é um exemplo de base?',
['NaOH','HCl','CO₂','NaCl'],
0,
'NaOH é uma base forte em solução aquosa.',
'Uma reação entre HCl e NaOH pode produzir:',
['NaCl e H₂O','CO₂ e O₂','CH₄ e H₂','Fe e O₂'],
0,
'HCl + NaOH → NaCl + H₂O.'
),
...
'Solução',
'Solução é uma mistura homogénea constituída por soluto ou solutos distribuídos num solvente.',
[
'O soluto é a substância dissolvida.',
'O solvente é o componente que dissolve o soluto e geralmente está em maior quantidade.',
'A concentração indica a quantidade de soluto presente numa determinada quantidade de solução.',
'A diluição reduz a concentração através da adição de solvente.'
],
'Solução de sal',
'Uma quantidade conhecida de sal pode ser dissolvida em água para preparar uma solução com concentração determinada.',
'Laboratório',
'Preparar soluções corretamente é importante em laboratórios, hospitais, agricultura e indústria.',
'soluções',
'Pensar que adicionar água aumenta a quantidade de soluto.',
'Na diluição, a quantidade de soluto permanece constante enquanto o volume da solução aumenta.',
[
'Solução é mistura homogénea.',
'Soluto é dissolvido.',
'Solvente realiza a dissolução.',
'Diluição reduz a concentração.'
],
'Na preparação de uma solução de sal em água, o sal é:',
['Soluto','Solvente','Indicador','Catalisador'],
0,
'O sal é a substância dissolvida.',
'Na diluição de uma solução, normalmente adiciona-se:',
['Solvente','Mais soluto obrigatoriamente','Catalisador','Gás inerte'],
0,
'A adição de solvente aumenta o volume e reduz a concentração.'
),
...
'chem-11-u6',
'Termoquímica',
'Calor e entalpia das reações',
'Termoquímica',
'Termoquímica é o ramo da Química que estuda as variações de energia, especialmente calor, associadas às reações e transformações químicas.',
[
'Reações exotérmicas libertam energia para o ambiente.',
'Reações endotérmicas absorvem energia do ambiente.',
'A entalpia é uma grandeza termodinâmica utilizada para descrever variações de energia em processos a pressão constante.',
'A variação de entalpia pode ser representada por ΔH.'
],
'Combustão',
'A combustão de muitos combustíveis é uma reação exotérmica porque liberta energia para o ambiente.',
'Energia',
'A termoquímica ajuda a avaliar combustíveis, processos industriais e eficiência energética.',
'energia',
'Pensar que exotérmica significa que a reação não precisa de energia para começar.',
'Uma reação exotérmica pode necessitar de energia de ativação para iniciar, mesmo libertando energia no balanço global.',
[
'Exotérmica libera energia.',
'Endotérmica absorve energia.',
'ΔH representa variação de entalpia.',
'Combustão geralmente é exotérmica.'
],
'Uma reação exotérmica:',
['Liberta energia para o ambiente','Absorve sempre toda a energia disponível','Não envolve energia','Transforma energia em massa'],
0,
'Em uma reação exotérmica há libertação líquida de energia.',
'Se ΔH é negativo, a reação é geralmente:',
['Exotérmica','Endotérmica','Neutra obrigatoriamente','Impossível'],
0,
'ΔH negativo indica libertação líquida de calor em condições apropriadas.'
)
...
'chem-12-u1',
'Cinética Química',
'Velocidade e mecanismo das reações',
'Cinética química',
'Cinética química é o ramo da Química que estuda a velocidade das reações químicas, os mecanismos pelos quais ocorrem e os fatores que influenciam essa velocidade.',
[
'A velocidade pode ser expressa pela variação da concentração de reagentes ou produtos em função do tempo.',
'A concentração dos reagentes pode influenciar a frequência de colisões eficazes.',
'A temperatura geralmente aumenta a velocidade das reações.',
'Catalisadores fornecem um caminho reacional com menor energia de ativação.'
],
'Comprimido triturado',
'Um sólido triturado apresenta maior superfície de contacto, favorecendo interações com o solvente e podendo acelerar determinados processos.',
'Indústria',
'O controlo da velocidade é essencial na produção de medicamentos, alimentos, combustíveis e produtos químicos.',
'cinética',
'Pensar que um catalisador aumenta necessariamente a quantidade final de produto.',
'O catalisador altera a velocidade de chegada ao equilíbrio, mas não altera a constante de equilíbrio de uma reação em equilíbrio.',
[
'Cinética estuda velocidade.',
'Temperatura influencia a velocidade.',
'Concentração pode influenciar a velocidade.',
'Catalisadores reduzem a energia de ativação.'
],
'Qual fator geralmente aumenta a velocidade de muitas reações?',
['Aumento da temperatura','Remoção dos reagentes','Redução extrema do contacto','Eliminação das colisões'],
0,
'A temperatura aumenta a energia cinética das partículas e favorece colisões eficazes.',
'Qual é a função principal de um catalisador?',
['Aumentar a velocidade por um caminho de menor energia de ativação','Aumentar a massa dos reagentes','Ser consumido completamente','Alterar todos os produtos'],
0,
'O catalisador oferece uma rota reacional de menor energia de ativação.'
),
...
'Lei da velocidade',
'Lei da velocidade',
'A lei da velocidade relaciona a velocidade de uma reação com as concentrações das espécies que influenciam sua velocidade, de acordo com a determinação experimental ou com o mecanismo aplicável.',
[
'A ordem da reação indica como a velocidade depende da concentração de cada espécie na expressão da lei de velocidade.',
'Os expoentes da lei de velocidade não devem ser assumidos automaticamente a partir dos coeficientes da equação global.',
'A constante de velocidade depende da temperatura e das características da reação.',
'O estudo cinético ajuda a compreender mecanismos de reação.'
],
'Comparação experimental',
'Se duplicar a concentração de um reagente provocar uma alteração específica na velocidade, essa relação pode ajudar a determinar a ordem em relação ao reagente.',
'Investigação',
'A lei da velocidade é utilizada para prever e controlar processos químicos.',
'cálculo',
'Assumir que a equação global sempre fornece diretamente a lei da velocidade.',
'A lei de velocidade deve ser determinada de acordo com evidências experimentais ou por mecanismos elementares apropriados.',
[
'Lei da velocidade relaciona concentração e velocidade.',
'Ordens de reação aparecem como expoentes.',
'Constante de velocidade depende da temperatura.',
'Cinética ajuda a estudar mecanismos.'
],
'Na expressão v = k[A]², a ordem em relação a A é:',
['2','1','0','3'],
0,
'O expoente 2 indica segunda ordem em relação a A.',
'Se a concentração de A aumenta e a velocidade também aumenta, isso indica que:',
['A concentração pode influenciar a velocidade','A reação deixou de existir','A massa desapareceu','A temperatura é sempre zero'],
0,
'A relação entre concentração e velocidade é estudada experimentalmente.'
),
...
'chem-12-u2',
'Equilíbrio Químico',
'Estado de equilíbrio e princípio de Le Chatelier',
'Equilíbrio químico',
'Equilíbrio químico é um estado dinâmico de uma reação reversível em que as velocidades das reações direta e inversa são iguais, mantendo constantes as concentrações macroscópicas.',
[
'O equilíbrio não significa que a reação parou.',
'Uma perturbação pode provocar deslocamento do equilíbrio.',
'O princípio de Le Chatelier permite prever a resposta de um sistema a alterações de concentração, pressão ou temperatura.',
'A posição de equilíbrio depende das condições do sistema.'
],
'Síntese de amónia',
'N₂ e H₂ podem reagir reversivelmente para formar NH₃. Alterações nas condições podem modificar a composição de equilíbrio.',
'Fertilizantes',
'O equilíbrio químico é importante na produção industrial de substâncias, incluindo amónia.',
'equilíbrio',
'Pensar que no equilíbrio só existem produtos.',
'No equilíbrio podem coexistir reagentes e produtos, e as reações continuam ocorrendo.',
[
'Equilíbrio é dinâmico.',
'Velocidades direta e inversa são iguais.',
'Concentrações permanecem constantes.',
'Perturbações podem deslocar o equilíbrio.'
],
'No equilíbrio químico, as reações direta e inversa:',
['Continuam ocorrendo com velocidades iguais','Param completamente','Ocorrem apenas no sentido direto','Não possuem reagentes'],
0,
'O equilíbrio é dinâmico.',
'Adicionar reagente a um sistema em equilíbrio tende a:',
['Favorecer a resposta que consome parte do reagente adicionado','Parar todas as reações','Eliminar os produtos imediatamente','Não produzir qualquer resposta'],
0,
'O sistema responde à perturbação de acordo com o princípio de Le Chatelier.'
),
...
'A constante de equilíbrio é uma grandeza que relaciona as atividades ou concentrações das espécies químicas num sistema em equilíbrio e, para gases, pode também ser expressa em termos de pressões parciais.',
[
'Kc utiliza concentrações molares nas expressões escolares apropriadas.',
'Kp utiliza pressões parciais dos gases.',
'A forma da expressão depende da equação química balanceada.',
'A temperatura influencia o valor da constante de equilíbrio.'
],
'Reação gasosa',
'Em sistemas gasosos, as pressões parciais podem ser utilizadas para representar o estado de equilíbrio.',
'Indústria',
'Kc e Kp ajudam a avaliar quantitativamente sistemas químicos em equilíbrio.',
'cálculo',
'Pensar que Kc e Kp possuem sempre o mesmo valor.',
'Kc e Kp podem apresentar relações diferentes dependendo da reação e das condições.',
[
'Kc usa concentrações.',
'Kp usa pressões parciais.',
'A equação balanceada determina a expressão.',
'Temperatura influencia a constante.'
],
'Kp é baseada principalmente em:',
['Pressões parciais','Massas apenas','Volumes sólidos apenas','Número de recipientes'],
0,
'Kp é definida em termos das pressões parciais das espécies gasosas.',
'A expressão de Kc deve ser construída a partir:',
['Da equação química balanceada','Do nome do laboratório','Da cor dos reagentes','Do volume do recipiente apenas'],
0,
'Os coeficientes da equação balanceada determinam os expoentes na expressão de equilíbrio.'
),
...
'Segundo Brønsted-Lowry, um ácido é uma espécie que doa protões e uma base é uma espécie que aceita protões.',
[
'Uma reação ácido-base envolve transferência de protão.',
'O ião hidrónio H₃O⁺ representa a forma hidratada do protão em água.',
'Ácidos e bases podem ser fortes ou fracos.',
'A força de um ácido ou base está relacionada com a extensão da sua ionização ou dissociação em solução.'
],
'Ácido clorídrico em água',
'HCl transfere um protão para a água, formando H₃O⁺ e Cl−.',
'Laboratório',
'A teoria ácido-base permite interpretar neutralização, pH, indicadores e titulações.',
'acido_base',
'Confundir ácido forte com solução concentrada.',
'Força indica a extensão da ionização; concentração indica quantidade de soluto por volume.',
[
'Ácido doa protão.',
'Base aceita protão.',
'H₃O⁺ é o ião hidrónio.',
'Força e concentração são conceitos diferentes.'
],
'Segundo Brønsted-Lowry, uma base:',
['Aceita protão','Doa sempre eletrão','É sempre metálica','Não participa em reações'],
0,
'Base é a espécie que aceita protão.',
'Qual ião está diretamente associado à acidez em solução aquosa?',
['H₃O⁺','Na+','Cl−','Ca2+'],
0,
'O aumento da concentração de H₃O⁺ está associado ao aumento da acidez.'
),
...
'O produto iónico da água, Kw, é a constante de equilíbrio associada à autoionização da água e relaciona as concentrações de H₃O⁺ e OH−.',
[
'A 25 °C, para água pura, Kw é aproximadamente 1,0 × 10⁻¹⁴.',
'Em condições escolares usuais, pH e pOH estão relacionados por pH + pOH = 14 a 25 °C.',
'Ka caracteriza o equilíbrio de ionização de um ácido.',
'Kb caracteriza o equilíbrio de uma base.'
],
'Cálculo de pH',
'Para uma solução com concentração de H₃O⁺ igual a 10⁻³ mol/L, o pH é 3.',
'Análise da água',
'O controlo do pH é importante em água, agricultura, alimentos, processos industriais e análises laboratoriais.',
'pH',
'Pensar que pH 3 é três vezes mais ácido que pH 6.',
'A escala de pH é logarítmica; uma diferença de 3 unidades representa uma diferença de mil vezes na concentração de H₃O⁺.',
[
'Kw relaciona H₃O⁺ e OH−.',
'Ka descreve ionização ácida.',
'Kb descreve ionização básica.',
'pH é uma escala logarítmica.'
],
'Uma solução com [H₃O⁺] = 10⁻³ mol/L apresenta pH aproximadamente:',
['3','6','10','14'],
0,
'pH = -log(10⁻³) = 3.',
'Se pH = 4 a 25 °C, o pOH é:',
['10','4','7','14'],
0,
'pH + pOH = 14, então pOH = 14 - 4 = 10.'
),
...
'chem-12-u3',
'Equilíbrio em Solução Aquosa',
'Tampões, indicadores, solubilidade e titulação',
'Solução tampão',
'Solução tampão é uma solução que resiste relativamente a variações de pH quando pequenas quantidades de ácido ou base são adicionadas.',
[
'Tampões geralmente envolvem um ácido fraco e sua base conjugada ou uma base fraca e seu ácido conjugado.',
'Indicadores ácido-base mudam de cor numa faixa de pH característica.',
'A solubilidade descreve a capacidade de uma substância dissolver-se em determinado solvente sob certas condições.',
'Titulação é uma técnica usada para determinar a concentração de uma solução através de uma reação de composição conhecida.'
],
'Titulação ácido-base',
'Uma solução de concentração conhecida pode ser utilizada para determinar a concentração desconhecida de uma solução ácida ou básica.',
'Laboratório e saúde',
'Tampões são importantes em sistemas biológicos, enquanto titulações são utilizadas em análises químicas.',
'laboratório',
'Pensar que um tampão impede completamente qualquer alteração de pH.',
'Um tampão reduz a variação de pH, mas não torna a solução imune a qualquer quantidade de ácido ou base.',
[
'Tampões resistem a mudanças de pH.',
'Indicadores respondem ao pH.',
'Solubilidade depende das condições.',
'Titulação permite determinar concentrações.'
],
'Qual é uma característica de uma solução tampão?',
['Resistir a pequenas variações de pH','Ter sempre pH 7','Não possuir água','Não reagir com nenhuma substância'],
0,
'O sistema tampão reduz alterações de pH após pequenas adições de ácido ou base.',
'Uma titulação pode ser utilizada para determinar:',
['A concentração de uma solução desconhecida','Somente a massa do recipiente','A cor de qualquer substância','A temperatura do ambiente'],
0,
'A titulação relaciona volumes e concentrações através de uma reação química conhecida.'
),
...
'Química',
'chem-12-u4',
'Reações Redox e Eletroquímica',
'Oxidação, redução e número de oxidação',
'Reações redox',
'Reações de oxidação-redução são processos químicos que envolvem transferência de eletrões ou alteração dos números de oxidação das espécies participantes.',
[
'Oxidação corresponde à perda de eletrões ou aumento do número de oxidação.',
'Redução corresponde ao ganho de eletrões ou diminuição do número de oxidação.',
'O agente oxidante recebe eletrões e sofre redução.',
'O agente redutor fornece eletrões e sofre oxidação.'
],
'Corrosão do ferro',
'Na corrosão, o ferro sofre oxidação enquanto outras espécies participam dos processos de redução.',
'Proteção de metais',
'O estudo das reações redox ajuda a compreender corrosão, baterias, produção de metais e processos eletroquímicos.',
'redox',
'Confundir o agente oxidante com a espécie oxidada.',
'O agente oxidante é aquele que provoca oxidação em outra espécie e, por isso, sofre redução.',
[
'Oxidação envolve perda de eletrões.',
'Redução envolve ganho de eletrões.',
'O oxidante é reduzido.',
'O redutor é oxidado.'
],
'Qual processo corresponde à perda de eletrões?',
['Oxidação','Redução','Neutralização','Diluição'],
0,
'Perda de eletrões corresponde à oxidação.',
...
'chem-12-u4',
'Reações Redox e Eletroquímica',
'Pilhas, força eletromotriz e eletrólise',
'Eletroquímica',
'Eletroquímica é o ramo da Química que estuda a relação entre reações químicas e energia elétrica, incluindo a produção ou utilização de corrente elétrica em processos redox.',
[
'Uma célula galvânica transforma energia química de uma reação espontânea em energia elétrica.',
'A pilha de Daniell é um exemplo clássico de célula galvânica.',
'A força eletromotriz está relacionada com a diferença de potenciais dos eletrodos.',
'Na eletrólise, energia elétrica é utilizada para promover uma transformação química não espontânea.'
],
'Pilha de Daniell',
'Uma pilha de Daniell utiliza reações redox separadas em dois eletrodos para produzir corrente elétrica.',
'Energia',
'Pilhas e baterias são importantes em equipamentos eletrónicos, transporte, telecomunicações e sistemas de energia.',
'eletroquímica',
'Pensar que toda pilha funciona porque cria eletrões do nada.',
'A reação redox provoca transferência de eletrões através de um circuito externo.',
[
'Pilhas convertem energia química em elétrica.',
'Eletrólise utiliza energia elétrica.',
'Reações redox movimentam eletrões.',
'Potenciais permitem analisar espontaneidade.'
],
'Uma pilha galvânica converte principalmente:',
['Energia química em energia elétrica','Energia elétrica em massa','Calor em matéria','Luz em protões'],
0,
'Uma reação redox espontânea pode produzir energia elétrica numa célula galvânica.',
'A eletrólise utiliza:',
['Energia elétrica para promover uma reação química','Somente água','Nenhuma fonte de energia','Apenas luz solar'],
0,
'A eletrólise força uma transformação química através de energia elétrica.'
),
...
'chem-12-u5',
'Química Orgânica',
'Hidrocarbonetos, funções orgânicas e biomoléculas',
'Química orgânica',
'Química orgânica estuda principalmente compostos de carbono, incluindo hidrocarbonetos, funções orgânicas, biomoléculas e materiais macromoleculares.',
[
'Hidrocarbonetos contêm carbono e hidrogénio.',
'Álcoois, fenóis, éteres, aldeídos, cetonas, ácidos carboxílicos e ésteres possuem grupos funcionais específicos.',
'Aminas e amidas contêm nitrogénio e possuem importantes aplicações biológicas e industriais.',
'Carboidratos, lípidos, aminoácidos e proteínas são classes importantes de moléculas relacionadas com os seres vivos.'
],
'Proteínas e aminoácidos',
'Aminoácidos são unidades estruturais que podem formar proteínas através de ligações peptídicas.',
'Biologia e saúde',
'A Química orgânica ajuda a compreender alimentos, medicamentos, metabolismo, materiais sintéticos e processos biológicos.',
'biomoléculas',
'Pensar que todas as substâncias orgânicas são artificiais.',
'Existem compostos orgânicos naturais e sintéticos.',
[
'Carbono forma grande diversidade de compostos.',
'Grupos funcionais determinam propriedades.',
'Biomoléculas possuem funções essenciais nos seres vivos.',
'Polímeros podem ser naturais ou sintéticos.'
],
'Qual é uma biomolécula constituída por aminoácidos?',
['Proteína','Água','Cloreto de sódio','Oxigénio'],
0,
'Proteínas são macromoléculas formadas por cadeias de aminoácidos.',
'Qual classe inclui substâncias como glicose e amido?',
['Carboidratos','Metais','Óxidos metálicos','Haletos'],
0,
'Glicose e amido são exemplos de carboidratos.'
)
